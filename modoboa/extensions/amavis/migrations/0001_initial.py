...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'amavis.msgrcpt': {
            'Meta': {'unique_together': "(('mail', 'rid'),)", 'object_name': 'Msgrcpt', 'db_table': "u'msgrcpt'", 'managed': 'False'},
        ...
        'amavis.msgs': {
            'Meta': {'object_name': 'Msgs', 'db_table': "u'msgs'", 'managed': 'False'},
        ...
        'amavis.policy': {
            ...
            'bypass_header_checks': ('django.db.models.fields.CharField', [], {'max_length': '3', 'blank': 'True', 'null': 'True'}),
            ...
            'other_quarantine_to': ('django.db.models.fields.CharField', [], {'max_length': '192', 'null': 'True', 'blank': 'True'}),
        ...
        'amavis.quarantine': {
            'Meta': {'ordering': "['-mail__time_num']", 'unique_together': "(('mail', 'chunk_ind'),)", 'object_name': 'Quarantine', 'db_table': "u'quarantine'", 'managed': 'False'},
