...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Mailbox.quota_value'
        db.alter_column(u'admin_mailbox', 'quota_value_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['admin.Quota'], unique=True))
        # Adding unique constraint on 'Mailbox', fields ['quota_value']
        db.create_unique(u'admin_mailbox', ['quota_value_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Mailbox', fields ['quota_value']
        db.delete_unique(u'admin_mailbox', ['quota_value_id'])


        # Changing field 'Mailbox.quota_value'
        db.alter_column(u'admin_mailbox', 'quota_value_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['admin.Quota']))
    ...
    models = {
        ...
        'admin.mailbox': {
            ...
            'quota_value': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['admin.Quota']", 'unique': 'True'}),
