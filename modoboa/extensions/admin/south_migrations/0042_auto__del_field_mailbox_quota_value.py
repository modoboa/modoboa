...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Mailbox.quota_value'
        db.delete_column(u'admin_mailbox', 'quota_value_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Mailbox.quota_value'
        raise RuntimeError("Cannot reverse this migration. 'Mailbox.quota_value' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Mailbox.quota_value'
        db.add_column(u'admin_mailbox', 'quota_value',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['admin.Quota'], unique=True),
                      keep_default=False)
