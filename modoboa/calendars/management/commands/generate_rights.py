...
"""
    ...
    def _user_access_rules(self):
        ...
        Rules and permissions are the ones returned by the rights API, see
        the rights module.
        ...
        """
        qset = (
            rights.get_effective_access_rules()
            .order_by("pk")
            .values_list(
                "pk",
                "mailbox__address",
        ...
        for pk, address, domain, path, read, write in qset.iterator():
            ...
            self._generate_acr(
                f"acr-{pk}-{email}-to-{path}",
                email,
                path,
                rights.get_share_permissions(read, write),
            )
