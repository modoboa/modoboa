...
const routes = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                component: () =>
                    import('../views/login/PasswordRecoveryView.vue'),
            },
            {
    ...
    },
    {
        ...
        children: [
                ...
                children: [
                    {
                        ...
                        name: 'DomainList',
                        component: () =>
                            import('@/views/admin/domains/DomainsView.vue'),
                        meta: {
                            requiresAuth: true,
                            allowedRoles: [
                                'DomainAdmins',
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import('@/views/admin/domains/DomainView.vue'),
                    },
                    {
                        path: ':id/edit',
                        name: 'DomainEdit',
                        ...
                        component: () =>
                            import('@/views/admin/domains/DomainEditView.vue'),
                    },
                ],
            },
            {
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                '@/views/admin/imap_migration/MigrationsView.vue'
                            ),
                        meta: {
                            requiresAuth: true,
                    ...
                    },
                    {
                        path: 'providers',
                        component: () =>
                            import('@/layouts/default/DefaultLayout.vue'),
                        meta: {
                            requiresAuth: true,
                            allowedRoles: ['Resellers', 'SuperAdmins'],
                        },
                        children: [
                            {
                                ...
                                component: () =>
                                    import(
                                        '@/views/admin/imap_migration/ProvidersView.vue'
                                    ),
                                meta: {
                                    requiresAuth: true,
                                    allowedRoles: ['Resellers', 'SuperAdmins'],
                            ...
                            },
                            {
                                ...
                                component: () =>
                                    import(
                                        '@/views/admin/imap_migration/ProviderEditView.vue'
                                    ),
                                meta: {
                                    requiresAuth: true,
                                    allowedRoles: ['Resellers', 'SuperAdmins'],
                ...
                children: [
                    {
                        ...
                        component: () =>
                            import(
                                '@/views/admin/identities/IdentitiesView.vue'
                            ),
                        meta: {
                            requiresAuth: true,
                            allowedRoles: [
                    ...
                    },
                    {
                        ...
                        name: 'AccountDetail',
                        component: () =>
                            import('@/views/admin/identities/AccountView.vue'),
                        meta: {
                            requiresAuth: true,
                            allowedRoles: [
                                'DomainAdmins',
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                '@/views/admin/identities/AccountEditView.vue'
                            ),
                        meta: {
                            requiresAuth: true,
                            allowedRoles: [
                    ...
                    },
                    {
                        ...
                        name: 'AliasDetail',
                        component: () =>
                            import('@/views/admin/identities/AliasView.vue'),
                        meta: {
                            requiresAuth: true,
                            allowedRoles: [
                                'DomainAdmins',
                    ...
                    },
                    {
                        ...
                        component: () =>
                            import(
                                '@/views/admin/identities/AliasEditView.vue'
                            ),
                        meta: {
                            requiresAuth: true,
                            allowedRoles: [
            ...
            },
            {
                ...
                name: 'Statistics',
                component: () =>
                    import('@/views/admin/monitoring/StatisticsView.vue'),
                meta: {
                    requiresAuth: true,
                    allowedRoles: ['SuperAdmins'],
                },
            },
            {
                ...
                name: 'AuditTrail',
                component: () =>
                    import('@/views/admin/monitoring/AuditTrailView.vue'),
                meta: {
                    requiresAuth: true,
                    allowedRoles: ['SuperAdmins'],
                },
            },
            {
                ...
                name: 'MessageLog',
                component: () =>
                    import('@/views/admin/monitoring/MessagesView.vue'),
                meta: {
                    requiresAuth: true,
