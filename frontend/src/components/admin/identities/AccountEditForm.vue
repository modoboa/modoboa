                                    ...
                                    >
                                        <v-col cols="6">
                                            <div class="mr-2">
                                                ...
                                                {{
                                                    $gettext(
                                                        'Number of allowed mailboxes:'
                                                    )
                                                }}
                                                {{
                                                    editedAccount.resources[0]
                                                        .max_value
                                                }}
                                            </div>
                                        </v-col>
                                        <v-col cols="6">
                                            <div class="mr-2">
                                                ...
                                                {{
                                                    $gettext(
                                                        'Number of allowed mailbox aliases:'
                                                    )
                                                }}
                                                {{
                                                    editedAccount.resources[1]
                                                        .max_value
                                                }}
                                            </div>
                                        </v-col>
