  ...
  themeConfig: {
    ...
    nav: [
      ...
      { text: 'Contributing', items: [
        { text: 'Getting Start', link: '/contributing/getting_start'},
        { text: 'Write Plugin', link: '/contributing/plugin_api'},
        { text: 'Translate', link: '/contributing/translation'},
        { text: 'Contributor', link: '/contributors'},
      ]}
    ],
    ...
    socialLinks: [
      ...
      { icon: 'twitter', link: 'https://modoboa.org/'},
      { icon: {
